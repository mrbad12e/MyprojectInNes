...
import {Box, Container, FormControl, ImageList, ImageListItem, InputLabel, MenuItem, Select, Typography, IconButton} from '@mui/material'
    ...
    return (
        <Container>
            <Wrapper>
                ...
                <Container>
                    <Typography variant='h4' py={2}>{product.title}</Typography>
                    <Typography variant='h5' py={2}>{product.descrip}</Typography>
                    <Typography variant='h5' py={2}>$ {product.price}</Typography>
                    <Box display={'flex'} flexDirection={'row'} py={2} alignItems={'center'} paddingY={2}>
                        <Box width='50%' display={'flex'} flexDirection={'row'} alignItems={'center'} >
                            <Typography fontSize={20} fontWeight={200}>Color</Typography>
                            {product.color.map((c) => (
